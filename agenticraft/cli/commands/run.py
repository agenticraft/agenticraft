...
def _run_python_agent(file_path: Path, prompt: Optional[str], interactive: bool, 
                     config: Optional[str], provider: Optional[str]):
    ...
    if agent is None:
        ...
        click.echo("Make sure your file exports an 'agent' variable or 'create_agent' function")
        raise click.Abort()
...
def _run_yaml_agent(file_path: Path, prompt: Optional[str], interactive: bool, 
