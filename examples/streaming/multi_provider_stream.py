...
from agenticraft.core.streaming import StreamingResponse, StreamInterruptedError
...
class StreamingMetrics:
    ...
    def summary(self) -> Dict[str, Any]:
        """Get metrics summary."""
        return {
            "first_token_latency": f"{self.first_token_time:.3f}s" if self.first_token_time else "N/A",
...
async def parallel_streaming_demo():
    ...
    agents = [
        Agent(name="Scientist", instructions="You are a scientist. Be precise and factual."),
        Agent(name="Poet", instructions="You are a poet. Be creative and metaphorical."),
        Agent(name="Child", instructions="You are a 5-year-old child. Be simple and curious.")
    ]
