...
class TestMCPRegistry:
    ...
    def test_list_tools(self, registry, sample_mcp_tool):
        ...
        registry.register_mcp_tool(
            MCPTool(name="search", description="Search tool"), category="web"
        )
    ...
    def test_validate_tool_call(self, registry, sample_mcp_tool):
        ...
        # Valid call
        registry.validate_tool_call("calculator", {"expression": "2 + 2"})
    ...
    def test_validate_enum_parameter(self, registry):
        ...
        # Valid enum value
        registry.validate_tool_call("converter", {"unit": "meters"})

        # Invalid enum value
        with pytest.raises(ToolError, match="Must be one of"):
            registry.validate_tool_call("converter", {"unit": "kilometers"})
