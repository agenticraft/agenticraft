...
try:
    ...
    StreamInterruptedError = None
    collect_stream = None
    stream_to_string = None
    create_mock_stream = None

# Skip all tests if module not implemented
pytestmark = pytest.mark.skipif(
    not STREAMING_AVAILABLE, reason="Streaming functionality not yet implemented"
)
    ...
    async def test_agent_stream_basic(self):
        ...
        with patch("agenticraft.core.agent.ProviderFactory.create") as mock_factory:
            ...
            async def mock_stream(*args, **kwargs):
                ...
                yield StreamChunk(content="world!", token="world!", is_final=True)
        ...
        with patch("agenticraft.core.agent.ProviderFactory.create") as mock_factory:
            ...
            async def mock_stream(*args, **kwargs):
                ...
                raise StreamInterruptedError(
                    "Test interruption", partial_response="Hello "
                )
...
class TestProviderStreaming:
    ...
    @pytest.mark.skipif(
        ...
        reason="OpenAI tests require OPENAI_API_KEY environment variable",
    )
    ...
    @pytest.mark.skipif(
        ...
        reason="Anthropic tests require ANTHROPIC_API_KEY environment variable",
    )
    ...
    @pytest.mark.skipif(
        ...
        reason="Ollama tests require OLLAMA_HOST environment variable and running server",
    )
