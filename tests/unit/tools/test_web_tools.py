...
from agenticraft.tools.web import check_url, extract_text, get_page_metadata, web_search
...
class TestWebSearchTool:
    ...
    async def test_news_search(self):
        ...
        results = await web_search.arun(
            query="latest technology news", search_type="news"
        )
    ...
    async def test_academic_search(self):
        ...
        results = await web_search.arun(
            query="machine learning research", search_type="academic"
        )
...
class TestExtractTextTool:
    ...
    async def test_extract_with_links(self):
        ...
        result = await extract_text.arun(
            url="https://example.com/article", include_links=True
        )
    ...
    async def test_extract_with_max_length(self):
        ...
        result = await extract_text.arun(
            url="https://example.com/article", max_length=50
        )
