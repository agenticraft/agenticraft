...
class TestMemoryEntry:
    ...
    def test_memory_entry_with_embedding(self):
        ...
        entry = MemoryEntry(
            content="Test content", entry_type=MemoryType.KNOWLEDGE, embedding=embedding
        )
...
class TestConversationMemory:
    ...
    async def test_store_conversation(self):
        ...
        user_msg = Message(role=MessageRole.USER, content="What's the weather like?")

        assistant_msg = Message(
            role=MessageRole.ASSISTANT, content="The weather is sunny today."
        )
