...
class TestPluginConfig:
    ...
    def test_plugin_config_custom(self):
        ...
        config = PluginConfig(
            enabled=True,
            config={"api_key": "test-key", "region": "us-east-1", "cache_ttl": 300},
            priority=10,
        )
...
class TestPluginContext:
    ...
    def test_plugin_context_with_shared_data(self):
        ...
        shared = {"api_client": MagicMock(), "database": MagicMock()}
...
class TestBasePlugin:
    ...
    def test_plugin_with_config(self):
        ...
        config = PluginConfig(enabled=True, config={"setting": "custom_value"})
        ...
        class DependentPlugin(BasePlugin):
            ...
            def get_info(self) -> PluginInfo:
                return PluginInfo(
                    ...
                    requires_packages=["requests>=2.28.0", "aiohttp>=3.8.0"],
                )
