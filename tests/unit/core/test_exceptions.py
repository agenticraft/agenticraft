...
class TestToolError:
    ...
    def test_tool_execution_error_with_details(self):
        ...
        error = ToolExecutionError(
            "Division by zero", tool_name="calculator", arguments={"a": 10, "b": 0}
        )
...
class TestConfigurationError:
    ...
    def test_configuration_error_with_field(self):
        ...
        error = ConfigurationError(
            "Invalid value for temperature", field="temperature", value=3.0
        )
...
class TestMemoryError:
    ...
    def test_memory_error_with_store_type(self):
        ...
        error = MemoryError("Failed to connect to vector store", store_type="chromadb")
...
class TestWorkflowError:
    ...
    def test_workflow_error_with_step_info(self):
        ...
        error = WorkflowError(
            "Step timeout", workflow="data_pipeline", step="process_data"
        )
        ...
        try:
            try:
                ...
                raise ToolExecutionError(
                    "Failed to parse tool response", tool_name="json_parser"
                ) from e
...
class TestExceptionUsagePatterns:
    ...
    def test_exception_serialization(self):
        ...
        error = ToolExecutionError(
            "Tool failed", tool_name="calculator", arguments={"a": 1, "b": 2}
        )
