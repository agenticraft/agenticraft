...
class TestMessage:
    ...
    def test_message_to_dict(self):
        ...
        msg = Message(
            role=MessageRole.USER, content="Test message", metadata={"key": "value"}
        )
...
class TestToolCall:
    ...
    def test_tool_call_creation(self):
        ...
        tool_call = ToolCall(
            id="call_123", name="search", arguments={"query": "Python tutorials"}
        )
    ...
    def test_tool_call_auto_id(self):
        ...
        tool_call = ToolCall(name="calculator", arguments='{"a": 5, "b": 3}')
    ...
    def test_tool_call_invalid_json_arguments(self):
        ...
        tool_call = ToolCall(name="search", arguments="plain text query")
...
class TestToolResult:
    ...
    def test_tool_result_success(self):
        ...
        result = ToolResult(
            tool_call_id="call_123", result={"temperature": 72, "condition": "sunny"}
        )
    ...
    def test_tool_result_with_error(self):
        ...
        result = ToolResult(
            tool_call_id="call_456", result=None, error="API rate limit exceeded"
        )
    ...
    def test_tool_result_json_serializable(self):
        ...
        result = ToolResult(
            tool_call_id="call_789", result={"data": [1, 2, 3], "status": "ok"}
        )
...
class TestCompletionResponse:
    ...
    def test_completion_response_basic(self):
        ...
        response = CompletionResponse(content="Hello, how can I help you?")
    ...
    def test_completion_response_with_tool_calls(self):
        ...
        response = CompletionResponse(
            content="I'll search for that and calculate.", tool_calls=tool_calls
        )
