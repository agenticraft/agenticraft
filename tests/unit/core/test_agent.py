...
from agenticraft.core.types import Message, MessageRole, ToolCall, ToolResult
...
class TestAgent:
    ...
    async def test_agent_run_with_memory(self):
        ...
        assert "Alice" in all_text or "alice" in all_text.lower(), f"Memory not found in messages"
