...
class TestBaseReasoning:
    ...
    def test_custom_reasoning_pattern(self):
        ...
        class CustomReasoning(BaseReasoning):
            def __init__(self):
                super().__init__(name="custom", description="Custom reasoning pattern")
...
class TestReasoningIntegration:
    ...
    def test_switching_reasoning_patterns(self):
        ...
        patterns = [SimpleReasoning(), ChainOfThought()]
    ...
    def test_reasoning_with_complex_data(self):
        ...
        trace.add_step(
            "load_data",
            {"source": "database", "records": 1000, "fields": ["id", "name", "value"]},
        )

        trace.add_step(
            "analyze",
            {
                "statistics": {"mean": 45.2, "median": 42.0, "std_dev": 12.3},
