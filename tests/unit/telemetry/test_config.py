...
from agenticraft.telemetry.config import (
    test_config as create_test_config,
)
...
class TestTelemetryConfig:
    ...
    def test_to_env_dict(self):
        ...
        config = TelemetryConfig(
            resource=ResourceConfig(service_name="my-service", service_version="2.0.0"),
            trace_exporter=ExporterConfig(
                endpoint="http://jaeger:4317", headers={"auth": "token123"}
            ),
    ...
    def test_resource_attributes(self):
        ...
        config = ResourceConfig(
            ...
            attributes={"deployment.region": "us-west-2", "custom.team": "platform"},
        )
