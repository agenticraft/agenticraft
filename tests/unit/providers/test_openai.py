...
from agenticraft.core.exceptions import ProviderAuthError, ProviderError
...
class TestOpenAIProvider:
    ...
    def test_initialization_from_env(self):
        ...
        try:
            ...
            provider = OpenAIProvider(api_key="sk-env-key")
    ...
    def test_initialization_without_api_key(self):
        ...
        # More comprehensive env cleanup
        env_vars = ["OPENAI_API_KEY", "AGENTICRAFT_OPENAI_API_KEY"]
        ...
        try:
            ...
            with patch("agenticraft.providers.openai.settings", mock_settings):
                with patch("agenticraft.providers.openai.os.getenv", return_value=None):
                    # Now all three sources return None:
                    # kwargs.get("api_key") - not provided
                    # settings.openai_api_key - mocked to None
                    # os.getenv("OPENAI_API_KEY") - mocked to None
    ...
    async def test_client_creation(self, provider):
        ...
        with patch.dict(
            "sys.modules", {"openai": MagicMock(AsyncOpenAI=mock_client_class)}
        ):
    ...
    def test_initialization_with_custom_base_url(self):
        ...
        provider = OpenAIProvider(
            api_key="sk-test-key", base_url="https://custom.openai-proxy.com/v1"
        )
        assert provider.base_url == "https://custom.openai-proxy.com/v1"

    def test_initialization_with_custom_model(self):
        """Test initialization with custom default model."""
        provider = OpenAIProvider(api_key="sk-test-key", model="gpt-3.5-turbo-16k")
